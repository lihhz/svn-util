...
public class LoggerSupport {
    ...
    public static synchronized void setLogOutFile(File logOutFile) throws IOException {
        ...
        if (LoggerSupport.logOutFile != null) {
            try {
                logOutFileStream = new RandomAccessFile(LoggerSupport.logOutFile, "rw");
                logOutFileStream.seek(LoggerSupport.logOutFile.length());
            } catch (IOException e) {
                closeStream(logOutFileStream);
                logOutFileStream = null;
                throw e;
    ...
    public static void setLogOutTarget(boolean isOutToConsole, boolean isOutToFile) {
    	LoggerSupport.isOutToConsole = isOutToConsole;
        LoggerSupport.isOutToFile = isOutToFile;
    }
    ...
    public static void normal(String message) {
        printLog(Level.INFO, Level.INFO.tag, message, false);
    }
    ...
    protected static void printLog(Level level, String tag, String message, boolean isOutToErr) {
